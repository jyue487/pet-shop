...
contract('Adoption', (accounts) => {
    ...
    describe("adopting a pet and retrieving account address", async () => {
        ...
        it("can fetch the collection of all get owners addresses", async () => {
            const adopters = await adoption.getAdopters();
            assert.equal(adopters[8], expectedAdopter, "The owner of the adopted pet should be the last account.");
        });
    });
});